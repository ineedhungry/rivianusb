...
if [ ! -d /mutable/RivianCam ] && [ -d /backingfiles/RivianCam ]
then
  log_progress "Moving RivianCam symlink folder from backingfiles to mutable"
  mv /backingfiles/RivianCam /mutable/RivianCam
fi
